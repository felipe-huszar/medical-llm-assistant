            ...
            messages = [
                {
                    ...
                    "content": (
                        ...
                        "A ausência de detalhes acessórios, fatores de risco adicionais ou exames ainda não realizados não impede 'supported_hypothesis' quando o quadro clínico central já for suficientemente característico.\n"
